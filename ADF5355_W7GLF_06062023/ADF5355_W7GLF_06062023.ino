...
//
//   update June      7, 2023  W7GLF fixed problem found by Pablo, KI7OJL around line 1230. 
...
void loop()
{
  ...
  if ((RFint != RFintold) || (rflevel != rflevelold) || (modif==1) || (HERTZ != HERTZold) ) {
    ...
    DebugSerialPrint64 ("FVCO at 2 is ", FVCO, " 1E-1 deciHz");
    ...
    // Thanks Pablo for catching bug here 
    init64(HZ,0,HERTZ*10*RF_Divider);
