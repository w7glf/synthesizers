...
unsigned int long frequency_table [16] =
          {
            1136,  // 0  - 1136*9 => 10224 + 144 => 10368
            1104,  // 1  - 1104*9 => 9936 + 432 => 10368
             875,  // 2  - 875 + 28 => 903
            1152,  // 3  - 1152 + 28 => 1296 
            2160,  // 4  - 2160 + 144 => 2304
            1872,  // 5  - 1872 + 432 => 2304
            3312,  // 6  - 3312 + 144 => 3456 
            3024,  // 7  - 3024 + 432 => 3456
            1872,  // 8  - 1872*3 => 5616 + 144 => 5760
            1776,  // 9  - 1776*3 => 5328 + 432 => 5760
               0,  // 10 - 
               0,  // 11 - 
               0,  // 12 - 
               0,  // 13 - 
               0,  // 14 - 
            1152   // 15 - For testing - good harmonics to 10 GHz at 2304, 3456, 5760, 10368
          };
//
